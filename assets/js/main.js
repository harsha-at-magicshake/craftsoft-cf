...
function initRandomFloatingCards() {
  ...
  const items = [
    ...
    },
    {
      icon: "fab fa-aws",
      text: "AWS Cloud",
      gradient: "linear-gradient(135deg, #FF9500, #FFBE0B)",
    },
    {
      icon: "fab fa-python",
      text: "Python Dev",
    ...
    // Services
    {
      ...
      gradient: "linear-gradient(135deg, #2896cd, #74b9ff)",
    },
    {
...
function initCourseFilter() {
  ...
  filterTabs.forEach((tab) => {
    tab.addEventListener("click", () => {
      ...
      const scrollTarget =
        document.querySelector(".courses-page") ||
  ...
  if (filterParam) {
    const targetTab = Array.from(filterTabs).find(
      (tab) => tab.getAttribute("data-filter") === filterParam,
    );
    if (targetTab) {
...
function initShareCourse() {
  ...
  const shareText = encodeURIComponent(
    `Check out this course: ${document.title}`,
  );
...
function initDynamicContent() {
  const allCourses = [
    {
      name: "Graphic Design",
      url: "/c-graphic-design/",
      icon: "fas fa-swatchbook",
      desc: "Master Adobe Creative Suite and visual communication.",
      features: ["Photoshop & Illustrator", "Brand Identity", "Portfolio"],
    },
    {
      name: "UI/UX Design",
      url: "/c-ui-ux/",
      ...
      features: ["Figma & XD", "User Research", "Prototyping"],
    },
    {
      name: "Full Stack MERN",
      url: "/c-full-stack/",
      icon: "fas fa-layer-group",
      desc: "Build production-ready web applications with MERN.",
      features: ["React & Node.js", "MongoDB", "Deployment"],
    },
    {
      name: "Python Full Stack",
      url: "/c-python/",
      icon: "fab fa-python",
      desc: "Master Python, Django, and modern web development.",
      features: ["Python & Django", "REST APIs", "Database Design"],
    },
    {
      name: "Java Full Stack",
      url: "/c-java/",
      icon: "fab fa-java",
      desc: "Build scalable enterprise applications with Java Spring.",
      features: ["Spring Boot", "Hibernate", "Microservices"],
    },
    {
      name: "React Development",
      url: "/c-react/",
      icon: "fab fa-react",
      desc: "Master front-end development with the React library.",
      features: ["Hooks & Context", "Redux", "Architecture"],
    },
    {
      name: "DSA Mastery",
      url: "/c-dsa/",
      icon: "fas fa-code-branch",
      desc: "Master Algorithms and Data Structures for interviews.",
      features: ["Recursion", "Graphs", "Dynamic Prog"],
    },
    {
      name: "SQL Mastery",
      url: "/c-sql/",
      icon: "fa-solid fa-database",
      desc: "Master databases and advanced data querying.",
      features: ["Complex Joins", "Optimization", "Stored Procs"],
    },
    {
      name: "AI & ML",
      url: "/c-ai-ml/",
      icon: "fa-solid fa-brain",
      desc: "Build intelligent systems with data and algorithms.",
      features: ["Machine Learning", "Python for AI", "Neural Networks"],
    },
    {
      name: "Data Analytics",
      url: "/c-data-analytics/",
      icon: "fas fa-chart-area",
      desc: "Turn raw data into meaningful business insights.",
      features: ["Python & SQL", "Power BI & Tableau", "Statistics"],
    },
    {
      name: "DevOps Engineering",
      url: "/c-devops/",
      icon: "fas fa-infinity",
      desc: "Master CI/CD pipelines and infrastructure scaling.",
      features: ["Docker & K8s", "Jenkins", "Terraform"],
    },
    {
      name: "AWS Cloud",
      url: "/c-aws/",
      icon: "fab fa-aws",
      desc: "Master cloud infrastructure on Amazon Web Services.",
      features: ["EC2 & S3", "Lambda & IAM", "Cloud Cert"],
    },
    {
      name: "Microsoft Azure",
      url: "/c-azure/",
      icon: "fab fa-microsoft",
      desc: "Master cloud solutions with Microsoft Azure.",
      features: ["Azure AD", "Cloud Apps", "Cert Prep"],
    },
    {
      name: "Cyber Security",
      url: "/c-cyber-security/",
      icon: "fa-solid fa-user-shield",
      desc: "Protect systems and data from cyber threats.",
      features: ["Network Security", "Ethical Hacking", "Defense"],
    },
    {
      name: "DevSecOps",
      url: "/c-devsecops/",
      icon: "fas fa-shield-alt",
      desc: "Integrate security into your DevOps pipelines.",
      features: ["Security Audit", "Automation", "Vulnerability"],
    },
    {
      name: "Salesforce Admin",
      url: "/c-salesforce/",
      icon: "fab fa-salesforce",
      desc: "Master the world#1 CRM platform and automation.",
      features: ["Sales Cloud", "CRM Basics", "Cert Prep"],
    },
    {
      name: "Salesforce Developer",
      url: "/c-salesforce-developer/",
      icon: "fab fa-salesforce",
      desc: "Build custom apps and logic on Salesforce.",
      features: ["Apex", "LWC", "Integrations"],
    },
    {
      name: "Salesforce Marketing Cloud",
      url: "/c-salesforce-marketing-cloud/",
      icon: "fa-solid fa-bullhorn",
      desc: "Master data-driven personalized marketing.",
      features: ["Journey Builder", "Audience", "Analytics"],
    },
    {
      name: "Oracle Fusion Cloud",
      url: "/c-oracle-fusion-cloud/",
      icon: "fa-solid fa-cloud",
      desc: "Learn enterprise ERP solutions with Oracle.",
      features: ["Supply Chain", "HR Cloud", "Fusion Admin"],
    },
    {
      name: "Python Programming",
      url: "/c-python-programming/",
      icon: "fab fa-python",
      desc: "Learn the core principles of Python programming.",
      features: ["Logic & Flow", "Data Structs", "OOPs"],
    },
    {
      name: "Automation with Python",
      url: "/c-automation-python/",
      icon: "fas fa-robot",
      desc: "Automate boring tasks with Python scripting.",
      features: ["Web Scraping", "File Ops", "Bots"],
    },
    {
      name: "Git & GitHub",
      url: "/c-git-github/",
      icon: "fab fa-github",
      desc: "Master version control and collaboration tools.",
      features: ["Branching", "PR Workflows", "Actions"],
    },
    {
      name: "Spoken English",
      url: "/c-spoken-english/",
      icon: "fas fa-user-ninja",
      desc: "Enhance your communication and public confidence.",
      features: ["Fluency & Accent", "Presentation", "Vocabulary"],
    },
    {
      name: "Soft Skills",
      url: "/c-soft-skills/",
      icon: "fas fa-people-arrows",
      desc: "Develop essential workplace and leadership skills.",
      features: ["Communication", "Teamwork", "Leadership"],
    },
    {
      name: "Resume & Interview Prep",
      url: "/c-resume-interview/",
      icon: "far fa-file-lines",
      desc: "Prepare for your dream career with mock sessions.",
      features: ["Resume Building", "Mock Interviews", "ATS Proofing"],
    },
    {
      name: "Handwriting Improvement",
      url: "/c-handwriting/",
      icon: "fas fa-pen-nib",
      desc: "Improve your handwriting and penmanship.",
      features: ["Strokes", "Consistency", "Practice"],
    },
  ];
  ...
  const allServices = [
    {
      ...
      icon: "fas fa-swatchbook",
      desc: "Stunning visuals for your brand identity.",
    },
    {
      name: "UI/UX Design",
      url: "/s-ui-ux-design/",
      icon: "fa-brands fa-figma",
      desc: "User-centered design solution for digital products.",
    },
    {
      name: "Web Development",
      url: "/s-web-development/",
      icon: "fas fa-globe",
      desc: "Custom, responsive websites that drive results.",
    },
    {
      name: "Brand Identity",
      url: "/s-branding/",
      icon: "fas fa-bullseye",
      desc: "Strategic branding to set you apart.",
    },
    {
    ...
    },
    {
      ...
      url: "/s-career-services/",
      icon: "fas fa-users",
      desc: "Expert guidance for your professional journey.",
    },
  ];
  ...
  if (footerCourses) {
    footerCourses.innerHTML = shuffle([...allCourses])
      .slice(0, 4)
      .map((c) => `<li><a href="${c.url}">${c.name}</a></li>`)
      .join("");
  }
  if (footerServices) {
    footerServices.innerHTML = shuffle([...allServices])
      .slice(0, 4)
  ...
  if (homeCoursesGrid) {
    const selected = shuffle(
      allCourses.filter(
        (c) =>
          !c.name.includes("Resume") &&
          !c.name.includes("English") &&
          !c.name.includes("Soft Skills"),
      ),
    ).slice(0, 3);
    homeCoursesGrid.innerHTML = selected
      .map(
        (c) => `
    ...
    const selected = shuffle(
      allCourses.filter(
        (c) =>
          c.name.includes("Resume") ||
          c.name.includes("English") ||
          c.name.includes("Soft"),
      ),
    ).slice(0, 3);
    homeCareerGrid.innerHTML = selected
      .map(
        (c) => `
            <div class="unified-card">
                <div class="unified-card-icon"><i class="${c.icon}"></i></div>
  ...
  if (homeServicesGrid) {
    ...
    homeServicesGrid.innerHTML = selected
      .map(
        (s) => `
            <div class="unified-card">
...
function initStealthMode() {
  ...
  const getCourseSlugFromPath = () => {
    ...
    // Try to infer course slug purely via substring checks to be robust
    const slugs = Object.keys(coursePriceMap);
    for (const slug of slugs) {
      if (path.includes(`/c-${slug}/`) || path.includes(`/courses/${slug}/`)) {
        return slug;
      }
    }
    return null;
  ...
  const updatePricing = () => {
    ...
    document.querySelectorAll(".price").forEach((el) => {
      if (isStealth) {
        ...
        const amount =
          courseSlug && coursePriceMap[courseSlug]
            ? coursePriceMap[courseSlug]
            : defaultAmount;
        const formattedAmount =
          typeof amount === "number" && amount.toLocaleString
            ? amount.toLocaleString("en-IN")
            : amount;
        el.innerHTML = `<span class="rupee-symbol">&#8377;</span>${formattedAmount}`;
      } else {
  ...
  coursesStat.addEventListener("touchstart", handleTripleAction, {
    passive: false,
  });
}
